# SHR-A11Y-FOCUS — 접근성 포커스·ARIA 유틸리티
...
**접근성 포커스·ARIA 유틸리티**. 2개 이상 Screen이 공유하는 재사용 컴포넌트/유틸리티를 구현하는 Task다.
...
`design-reference/D-001/DESIGN.md` — Do/Do Not(접근성), Header·Footer 포커스 규칙
...
- 폼·모달·탭·알림에 올바른 시맨틱 HTML+ARIA 상태, 44×44px 이상 터치 영역, 3px 포커스 링(`colors.focus-ring`).
