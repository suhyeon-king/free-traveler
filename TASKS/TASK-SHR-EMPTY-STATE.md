# SHR-EMPTY-STATE — 완성형 Empty State 원시 컴포넌트
...
**완성형 Empty State 원시 컴포넌트**. 2개 이상 Screen이 공유하는 재사용 컴포넌트/유틸리티를 구현하는 Task다.
...
- 사유 문장+이용 방법+다음 행동 CTA 3요소를 props로 강제(누락 시 타입 에러)하는 재사용 컴포넌트.

## Visual AC

- 빈 화면처럼 보이지 않게 최소 여백/아이콘 규칙 적용.
