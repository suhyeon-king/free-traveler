# SHR-FAVORITES-STORAGE — 즐겨찾기 localStorage 유틸리티
...
**즐겨찾기 localStorage 유틸리티**. 2개 이상 Screen이 공유하는 재사용 컴포넌트/유틸리티를 구현하는 Task다.
...
`design-reference/D-001/DESIGN.md` — Destination Card(즐겨찾기 아이콘)
...
- 여행지 즐겨찾기 토글·조회, 중복 즐겨찾기 생성 방지, 서버 전송 없음.
