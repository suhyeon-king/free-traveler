# SHR-SEO-METADATA — 페이지별 SEO 메타데이터 유틸리티
...
**페이지별 SEO 메타데이터 유틸리티**. 2개 이상 Screen이 공유하는 재사용 컴포넌트/유틸리티를 구현하는 Task다.
...
`design-reference/D-001/DESIGN.md` — 해당 없음(비시각 유틸리티) — 화면별 title/description 규칙만 UI_CONTRACT.md 참조
...
- 5개 Screen에 고유 title/description/canonical/Open Graph 제공하는 공통 헬퍼.
...
- TC-FUNC-070 (REQ-FUNC-070)
- TC-NF-030 (REQ-NF-030)
