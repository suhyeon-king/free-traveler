...
**URL 공유 유틸리티**. 2개 이상 Screen이 공유하는 재사용 컴포넌트/유틸리티를 구현하는 Task다.
...
`design-reference/D-001/DESIGN.md` — Mate Post Card / Destination Card(공유 아이콘)
...
- Web Share API 우선 시도, 실패 시 URL 클립보드 복사 폴백.
