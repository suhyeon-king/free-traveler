...
**Toast 인앱 알림**. 2개 이상 Screen이 공유하는 재사용 컴포넌트/유틸리티를 구현하는 Task다.
...
- 참가 요청 접수·승인/거절·신고 접수 등 상태 변경을 3~5초 노출 Toast로 알림, 이메일 발송 없이 대체.
